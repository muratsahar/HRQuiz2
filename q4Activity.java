    ...
    public void a_btnListener(View v) {
        if (click == 0) {
            if (!rb1.isChecked() && !rb2.isChecked() && !rb3.isChecked() && !rb4.isChecked()) {
                ...
                a_btn.setText(R.string.q_rep);
                click = 1;
            }
        } else {
            if (MainActivity.getScore() > 2 ) {
                Toast.makeText(this, "Dear "+MainActivity.getUserName()+" "+getString(R.string.win), Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, "Dear "+MainActivity.getUserName()+" "+getString(R.string.fail), Toast.LENGTH_SHORT).show();
            }
        }
    }
}
